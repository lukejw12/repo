...
tellraw @a [{"text":"[R.E.P.O.] ","color":"gold","bold":true},{"text":"Datapack loaded! Put carrot on stick in OFFHAND and right-click to grab objects.","color":"white","bold":false}]